...
const mockKanjiRecords: KanjiRecord[] = [
  {
    ...
    hanViet: ['Thực'],
    meanings: ['[thực] ăn, thức ăn, bữa ăn'],
    meaningsRaw: ['Nghĩa Hán Việt cổ: Thực - ăn, nuốt, dùng bữa; đồ ăn, lương thực.'],
    radical: 'thực 食 (+0 nét)',
    penStrokes: 'ノ丶丶フ一一フノ丶',
    strokeCount: 9,
    jlpt: 'N4',
    grade: 2,
    frequency: 84,
  ...
  },
  {
    ...
    kunReadings: ['もと'],
    hanViet: ['Bản'],
    meanings: ['[bản] sách, gốc, nguồn gốc'],
    meaningsRaw: ['Nghĩa Hán Việt cổ: Bản - gốc cây, cội nguồn; quyển sách, văn bản.'],
    radical: 'mộc 木 (+1 nét)',
    penStrokes: '一丨ノ丶一',
    strokeCount: 5,
    jlpt: 'N5',
  ...
  },
  {
    ...
    kunReadings: ['まな.ぶ'],
    hanViet: ['Học'],
    meanings: ['[học] học hỏi, bắt chước, trường học'],
    meaningsRaw: ['Nghĩa Hán Việt cổ: Học - tiếp thu tri thức, nghiên cứu khoa học.'],
    radical: 'tử 子 (+5 nét)',
    penStrokes: '丶丶ノ冖フフ一',
    strokeCount: 8,
    jlpt: 'N5',
  ...
  },
  {
    ...
    kunReadings: ['ひ', 'か'],
    hanViet: ['Nhật'],
    meanings: ['[nhật] ngày, mặt trời, ban ngày'],
    meaningsRaw: ['Nghĩa Hán Việt cổ: Nhật - mặt trời, thái dương; thời gian một ngày.'],
  ...
  },
  {
    ...
    kunReadings: [],
    hanViet: ['Hán'],
    meanings: ['[hán] Trung Quốc, Hán, nam giới'],
    meaningsRaw: ['Nghĩa Hán Việt cổ: Hán - sông Hán, triều đại nhà Hán, chữ Hán.'],
    radical: 'thủy 水 (+11 nét)',
    penStrokes: '丶丶一廿口一丨一フ丶',
    strokeCount: 14,
    jlpt: 'N3',
    grade: 3,
    frequency: 156,
...
export async function getWordOfTheDay(): Promise<TermRecord> {
  ...
  const common = mockTerms.filter((t) => t.isCommon && t.examples && t.examples.length > 0);
  return common[dayOfYear % common.length] || mockTerms[0];
}
